...
(function($PS) {
  ...
  var component = Halogen_Component.mkComponent({
      ...
      render: Data_Function["const"](Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("PureScript + Halogen works great!") ]))
  });
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(selectElement$prime("PureScript Halogen could not find element 'div.halogen'")("div.halogen"))(function (rootElement) {
      return Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)(rootElement);
  }));
